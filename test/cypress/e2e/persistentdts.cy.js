...
it("GET /permanent/deadbeef/api/dts", () => {
	cy.request({
		url: "/permanent/deadbeef/api/dts",
...
it("GET /permanent/deadbeef/api/dts/collections", () => {
	cy.request({
		url: "/permanent/deadbeef/api/dts/collections",
		failOnStatusCode: false,
	}).then((res) => {
...
// This route was broken when converting to Roaster
it.skip("GET /permanent/deadbeef/api/dts/document", () => {
	cy.request({
		url: "/permanent/deadbeef/api/dts/document",
		failOnStatusCode: false,
	}).then((res) => {
...
// This route was broken when converting to Roaster
it.skip("GET /permanent/deadbeef/api/dts/navigation", () => {
	cy.request({
		url: "/permanent/deadbeef/api/dts/navigation",
		failOnStatusCode: false,
	}).then((res) => {
