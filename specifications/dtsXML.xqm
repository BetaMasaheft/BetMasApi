...
declare
%rest:GET
%rest:path("/api/dts/collections/{$id}")
%output:method("json")
...
declare
%rest:GET
%rest:path("/api/dts/text/{$id}/{$level1}")
%output:method("json")
...
declare
%rest:GET
%rest:path("/api/dts/text/{$id}/{$level1}/{$line}")
%output:method("json")
...
declare
%rest:GET
%rest:path("/api/dts/text/{$id}/{$level1}/{$level2}/{$line}")
%output:method("json")
