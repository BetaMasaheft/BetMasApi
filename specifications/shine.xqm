...
declare
%rest:GET
%rest:path("/shine/api/collections")
%output:method("json")
function shine:main() {
...
declare
%rest:GET
%rest:path("/shine/api/resources/{$uuid}/metadata")
%output:method("json")
...
declare
%rest:GET
%rest:path("/shine/api/resources/{$uuid}/sections")
%output:method("json")
...
declare
%rest:GET
%rest:path("/shine/api/sections/{$uuid}/content_units")
%output:method("json")
